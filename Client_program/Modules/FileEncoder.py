...
class FileEncoder:
    ...
    def loadFile(self):
        filepath = self.fileLocation
        self.recordDict = self.bf.__read_csv_file__(filepath, True, 0)    
    ...
    def saveEncodings(self):
        jsonFileName = "./savedEncodings/encodings.json" # Needs a naming scheme or output argument
    ...
    def nameAttributes(self):#, argHandler):
        ...
        attributeTypes = self.attributeTypesList
...
def main():
    ...
    clientEncoder.loadFile()
    clientEncoder.nameAttributes()
